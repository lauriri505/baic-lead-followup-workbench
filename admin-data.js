window.BAIC_ADMIN_DATA = {
  ...
  transitionConfig: {
    ...
    results: [
      ...
      { code: "first_contact", name: "完成首次联系", actor: "system", enabled: true, sortOrder: 30, category: "contact", requiresCallbackTime: false, requiresReason: false },
      ...
      { code: "lost", name: "进入战败分类", actor: "system", enabled: true, sortOrder: 40, category: "lost", requiresCallbackTime: false, requiresReason: true },
      { code: "convert_prospect", name: "转潜客", actor: "sales", enabled: true, sortOrder: 70, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "no_intent", name: "无意向", actor: "sales", enabled: true, sortOrder: 40, category: "lost", requiresCallbackTime: false, requiresReason: true },
      { code: "unreachable", name: "未接通", actor: "sales", enabled: true, sortOrder: 50, category: "unreachable", requiresCallbackTime: false, requiresReason: false },
      { code: "invalid_number", name: "号码错误", actor: "sales", enabled: true, sortOrder: 60, category: "lost", requiresCallbackTime: false, requiresReason: true },
      ...
      { code: "trial_yes", name: "已试驾", actor: "sales", enabled: true, sortOrder: 80, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "trial_no", name: "未试驾", actor: "sales", enabled: true, sortOrder: 90, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "visit_yes", name: "已到店", actor: "sales", enabled: true, sortOrder: 100, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "visit_no", name: "未到店", actor: "sales", enabled: true, sortOrder: 110, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "deal_no", name: "暂未成交", actor: "sales", enabled: true, sortOrder: 120, category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "deal_yes", name: "已成交", actor: "sales", enabled: true, sortOrder: 130, category: "contact", requiresCallbackTime: false, requiresReason: false }
    ],
    flows: [
