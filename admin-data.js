window.BAIC_ADMIN_DATA = {
  ...
  transitionConfig: {
    ...
    results: [
      ...
      { code: "no_intent", name: "无意向", category: "lost", requiresCallbackTime: false, requiresReason: true },
      ...
      { code: "trial_yes", name: "已试驾", category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "trial_no", name: "未试驾", category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "visit_yes", name: "已到店", category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "visit_no", name: "未到店", category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "deal_no", name: "暂未成交", category: "contact", requiresCallbackTime: false, requiresReason: false },
      { code: "deal_yes", name: "已成交", category: "contact", requiresCallbackTime: false, requiresReason: false }
    ],
    flows: [
