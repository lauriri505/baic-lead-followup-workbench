window.CRM_DEMO_DATA = {
  ...
  leads: [
    ...
    },
    {
      ...
      state: "following", stateCode: "contacted", leadTags: [], unreachableCount: 0,
    ...
    },
    {
      ...
      state: "testdrive", stateCode: "prospect_lost", leadTags: ["valid_lead"], unreachableCount: 0,
      orderStatusCode: "UNMARKED", orderStatusHistory: [],
    ...
    },
    {
      ...
      state: "cash", stateCode: "contacted", leadTags: [], unreachableCount: 1,
      orderStatusCode: "UNMARKED", orderStatusHistory: [],
    ...
    },
    {
      ...
      state: "noIntent", stateCode: "prospect_lost", leadTags: ["valid_lead"], unreachableCount: 1,
      orderStatusCode: "UNMARKED", orderStatusHistory: [],
